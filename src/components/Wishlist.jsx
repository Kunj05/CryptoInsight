                ...
                <tbody className='w-full mb-4'>
                    {
                        watchlist.map((coinid) => (
                            <tr key={coinid} className=' flex w-full justify-evenly  py-2 text-xs vs:text-base hover:bg-[#87CEEB] text-[#FAF0E6] hover:font-bold hover:text-black rounded-md cursor-pointer'>
